all: flto_none flto_wrap_cxx flto_wrap_f90 flto_wrap_f90_cxx flto_wrap_f90_cxx_cc flto_wrap_f90_f90_cxx flto_all
...
flto_wrap_f90_cxx_cc: *.f90 *.cc *.cxx
	g++ 		-c -O3 -flto	matrix.cc
	g++ 		-c -O3 -flto 	formatrixFORTRAN_wrap.cxx
	gfortran 	-c -O3 			timerlib.f90
	gfortran 	-c -O3 -flto	formatrix.f90
	gfortran 	-c -O3 			perf_formatrix.f90
